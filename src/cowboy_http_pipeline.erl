...
upgrade( Req0, Env0, Handler, HandlerOpts ) ->
	...
	{ok, _ReqHandler} = cowboy_http_pipeline_response_serializer:start_handler( ResponseSerializer, Req0, Handler, HandlerOpts ),
	Req1 = cowboy_req:set( [{resp_state, done}], Req0 ),
	Env1 = [ {result, ok} | Env0 ],
	{ok, Req1, Env1}.
